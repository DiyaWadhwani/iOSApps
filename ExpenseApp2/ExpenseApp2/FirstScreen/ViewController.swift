...
//    let types = ["Groceries", "Rent", "Subscriptions", "Electronics"]
    ...
    override func viewDidLoad() {
        ...
        firstScreenView.tableViewExpense.separatorStyle = .none
        
        firstScreenView.tableViewExpense.delegate = self
        firstScreenView.tableViewExpense.dataSource = self
        
//        expenses.append(Expense(title: "One Plus 9", amount: 750.0, expenseType: types[3], image: nil))
//        expenses.append(Expense(title: "Iphone SE", amount: 350.0, expenseType: types[3], image: nil))
